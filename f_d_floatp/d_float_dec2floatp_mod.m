function bin=d_float_dec2floatp_mod(x,nbits);
...
% I and F are binary strings, E is a signed integer
...
% Modified by Mikaitis, does not work for nbits > 52
...
if bits_expo ~= 0
 % check the exponent for over(under)flow
