function [bin,binfix]=p_float2binfc(x,nbits);
%GM_FLOAT2BINFC  conversion of a float (double) to fixed point binary
...
% uses yet another and simpler method than in p_float2bin
...
% remove the leading and trailing zeros in bin
nq = length(F);
ind = find(I);
